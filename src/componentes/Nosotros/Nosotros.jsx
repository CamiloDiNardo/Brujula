  ...
  return (
    <div>
      ...
      <p className='EmpresaParrafo' data-aos='fade-up'>
        ...
        la necesidad de pasar por Buenos Aires. <b>Brujula</b> forma parte de la
        Alianza SkyTeam junto a 19 líneas aéreas del mundo, siendo la única
        compañía miembro de la región, A través de esta alianza ofrece a sus
        pasajeros conectividad a más de 1036 destinos en más de 170 países entre
        otros beneficios.En 2020 <b>Brujula</b> se fusiona con Austral Líneas
        Aéreas, aerolínea de cabotaje y regional que ya formaba parte del Grupo
        empresario. A través de esta fusión se unifican unidades, estructuras y
        procesos con el objetivo de brindar un mejor servicio a los pasajeros y
        pasajeras. En 1997, nace Aerohandling, la empresa de servicio de rampa y
        estiba de equipajes que cubre las necesidades de <b>Brujula</b> en todos
        los aeropuertos nacionales donde opera la compañía, y desde hace más de
        20 años, el grupo empresario también cuenta con JetPaq, la empresa de
        ...
        paquetes fuera del país. <b>Brujula</b> también integra a Optar, la
        operadora de servicios turísticos que gestiona las reservas y emisiones
        de los tickets aéreos de organismos estatales y dependencias públicas
        que forman parte del Estado Nacional. <b>Brujula</b> se encuentra en
        permanente crecimiento y evolución, incorporando las más avanzadas
        tecnologías y las mejores prácticas de la industria a nivel mundial
      </p>
