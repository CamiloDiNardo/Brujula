...
import styles from './Carrousell3D.module.css';
...
const Carrousell3D = ({ nombre }) => {
  ...
  return (
    <div className={styles.Carrousel3DContenedor}>
      <div className={styles.Carrousel3DContenedor__div}>
        {cantidadFotos.map((index) => {
          return (
            <figure className={styles.Carrousel3DContenedor__figure} key={index}>
              <img
                className={styles.Carrousel3DContenedor__img}
