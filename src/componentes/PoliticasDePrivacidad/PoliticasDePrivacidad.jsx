  ...
  return (
    <div>
      <p className={styles.Legales}>
        ...
        e-mail, nombre, apellido, domicilio completo, tipo y número de documento
        y otros datos opcionales, o cualquier otra información que permita
        individualizarlo. En todos los casos que usted brinde información
        ...
        facilitará el uso de los servicios que ofrece y la relación con el
        usuario. En los casos en que usted nos brinde su información personal,
        usted acepta y presta su consentimiento libre, expreso e informado para
        que dicha información personal sea utilizada en su propio beneficio
        ...
        integridad y confidencialidad de los datos considerados como personales.
        Brujula S.A. trata de evitar su adulteración, pérdida, consulta o
        tratamiento no autorizado, que permitan detectar desviaciones,
        intencionales o no, de información, ya sea que los riesgos provengan de
        la acción humana o del medio técnico utilizado. Para ello, es que le
        notificamos de nuestras prácticas de privacidad, y le explicamos las
        ...
        cualquier país y/o autoridades judiciales que así lo requieran y cuando
